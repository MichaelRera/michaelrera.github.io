...
The project will focus on applying network approaches to understand and <b>model the dynamics of gene networks driving ageing</b> in Drosophila and Humans. In particular, the project will focus on describing ageing as a propagation of network failures in the multi-layer interactome. The project is supported by a French national ANR JCJC funding (<a href="https://anr.fr/Projet-ANR-20-CE44-0010">ADAGIO</a>).
